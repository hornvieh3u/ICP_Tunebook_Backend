...
import { idlFactory } from './tune_book_backend.did.js';
export { idlFactory } from './tune_book_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TUNE_BOOK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tune_book_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tune_book_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tune_book_backend.did.js")._SERVICE>}
 */
export const tune_book_backend = createActor(canisterId);
